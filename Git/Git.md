...
- 2、输入命令“type nul>_._”
  ...
  > 创建空文件，输入命令“echo [fileContent]>_._”创建非空文件夹
...
- Linux 上安装：sudo apt-get install git
- Mac 上安装 XCode 自带 Git
...
- 返回第 n 个版本：`git reset --hard HEAD~n`
- 返回指定的版本：
